...
<section style="text-align: center;"><h4><p class="text-info">Un siglo después de Fisher: tiempo para un nuevo paradigma en génetica cuantitativa</p></h4></section>

<div class = "row">

<div class = "col-md-6">

<section style="text-align: justify;"><p class="text-secondary">Hace casi un siglo, los avances teóricos de Ronald Fisher establecieron la teoría que formó el campo de la genética cuantitativa. Desde entonces, el campo ha sido extremadamente productivo a la vez que se ajusta a este paradigma central.</p></section>
...
data.frame(
  ...
  scale_y_continuous(limits = c(1.0, 6.5)) +
  theme_void() +
