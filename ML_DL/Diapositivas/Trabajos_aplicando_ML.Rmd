...
<p class="text-warning"><strong><u>Random forest (bosque aleatorio)</u></strong></p>
...
<section style="text-align: justify;"><p class="text-secondary">Los <font color="black"><u>bosque aleatorio</u></font> se componen de árboles de decisión de distinta profundidad y hojas generadas dada la cantidad de características en los datos. RF utiliza aleatoriamente un subconjunto de características en lugar de todas ellas.</p>
...
<p class="text-secondary">donde <font color="black">$\hat{f^{I}}(x)$</font> es un estimador de bosque aleatorio, bootstrap individual de la muestra <font color="black">$i$</font>, <font color="black">$I$</font> es el número total de árboles que representan el número de estimadores, y <font color="black">$t^{*}_{i}(x)$</font> es la función del árbol de decisión individual igual a <font color="black">$t^{*}_{i}(x) = t(X; Z^{*}_{i1},... Z^{*}_{in})$</font></p>

<p class="text-secondary">donde <font color="black">$Z^{*}_{in} (n = 1, ..., N)$</font> es la n-ésima muestra de entrenamiento de conjuntos de datos dados con <font color="black">$x$</font> características de entrada y respuesta <font color="black">$y$</font>.</p>
