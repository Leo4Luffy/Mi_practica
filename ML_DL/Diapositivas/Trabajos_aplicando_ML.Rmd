...
<section style="text-align: justify;"><p class="text-secondary">La fórmula simple para explicar el problema de regresión (en el estudio a desarrollar se esta interesado en el problema de regresión) viene dada por la ecuación:</p>
