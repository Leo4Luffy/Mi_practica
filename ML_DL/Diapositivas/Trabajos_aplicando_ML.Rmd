...
<p class="text-secondary">En el aprendizaje supervisado, cuando la variable de salida es un valor categórico o discreto, entonces es <font color="black"><u>clasificación</u></font>, pero cuando la variable de salida es un valor continuo, entonces es una <font color="black"><u>regresión.</u></font></p></section>
...
<p class="text-info"><strong><u>Support vector regression forest (regresión de vector de soporte)</u></strong></p>
...
<section style="text-align: justify;"><p class="text-secondary">Se han propuesto un enfoque para manejar el clúster en los datos, el <font color="black"><u>machine learning de efectos mixtos</u></font>.</p>
