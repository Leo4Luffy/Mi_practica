...
<section style="text-align: justify;"><p class="text-primary">Luego los datos sin procesar se transforman en características. Así por ejemplo usando un método de codificación activa<!-- (Una codificación activa es un proceso que transforma características categóricas o discretas en una matriz numérica.)-->, el mes de parto se convierte en una característica denominada época de parto (sequía, transición y lluvia). La misma se convierte luego en valores numericos (1, 2 y 3, respectivamente) ya que la regresión de machine learning lo puede comprender mejor.</p></section>

<section style="text-align: justify;"><p class="text-primary">El resultado completo se puede ver en la tabla a continuación: →</p></section>
