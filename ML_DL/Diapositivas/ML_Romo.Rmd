...
<section style="text-align: justify;"><p class="text-primary">La forma más fácil de entender una distribución es visualizarla. Un histrograma como el de la imagen es un ejemplo de dicha visualización. De igual forma, las propiedades de una distribución se pueden describir mediante estadística descriptiva como:</p></section>
