...
data.frame(
  ...
  annotate(geom = 'text', x = 2.1, y = 2.6, label = 'Validación cruzada', family = 'gochi', size = 8.8, colour = 'black') +
  ...
  annotate(geom = 'text', x = 2.4, y = 1.68, label = 'Si los datos lo permiten:', family = 'gochi', size = 8.8, colour = 'black') +
...
<section style="text-align: justify;"><p class="text-primary">El modelo de regresión se ajusta con los datos de entrenamiento, se hacen predicciones basados en estos datos, y los datos de prueba se usan para medir el rendimiento del modelo.</p></section>
...
La salida impresa de division_datos, dice cuantas observaciones se tienen en el conjunto de entrenamiento, en el conjunto de pruebas, y cuando suman en total.
-->
