...
<section style="text-align: justify;"><p class="text-primary">Como el ejemplo anterior, la forma más fácil de entender una distribución es visualizarla.</p></section>

<section style="text-align: justify;"><p class="text-primary">De igual forma, las propiedades de una distribución se pueden describir mediante estadística descriptiva como la media, la mediana, el sesgo y la curtosis.</p></section>

```{r Imagen octocat 2, fig.align = 'center', out.width = "180", eval = TRUE, echo = FALSE, message = FALSE}
