...
<section style="text-align: center;"><h2><p class="text-info">Ajustando inicialmente un modelo básico de regresión</p></h2></section>

<br>

```{r, fig.align = 'center', out.width = '570', eval = TRUE, echo = FALSE, message = FALSE}
